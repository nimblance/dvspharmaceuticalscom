...
export function WhoWeAre() {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      image: damienImage,
      linkedinUrl: "https://www.linkedin.com/in/damien-dessis/",
      bio: [
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mt-4">
            A pharmaceutical specialized strategy company with unique expertise
            in pandemic vaccines, having partnered with more than 40 governments
            worldwide
          </p>
          <blockquote className="text-xl md:text-2xl font-semibold text-primary italic mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {teamMembers.map((member, index) => {
            ...
            return (
              <Card
                key={index}
                className={`flex flex-col hover-elevate transition-all duration-300 ${member.isAdvisor ? "border-primary/20" : ""}`}
